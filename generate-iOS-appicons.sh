...
magick convert $1 -resize 76x76 $1_38pt@2x.png
...
magick convert $1 -resize 114x114 $1_38pt@3x.png
magick convert $1 -resize 120x120 $1_40pt@3x.png
magick convert $1 -resize 120x120 $1_60pt@2x.png
magick convert $1 -resize 128x128 $1_64pt@2x.png
magick convert $1 -resize 136x136 $1_68pt@2x.png
...
magick convert $1 -resize 192x192 $1_64pt@3x.png
